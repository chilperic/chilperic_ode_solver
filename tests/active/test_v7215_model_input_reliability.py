...
def test_reliability_first_layout_removes_visible_three_panel_controls():
    pages = ['ode.html','steady.html','stochastic.html','optimization.html','statistics.html','fitting.html','linear-algebra.html','networks.html','ml.html','sciml.html','agent.html','symbolic.html','sensitivity.html','workbench.html']
    for page in pages:
        doc=soup(page)
