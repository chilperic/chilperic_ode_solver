...
def test_optimization_is_an_authored_v72_reference_shell():
    ...
    assert "src/core/optimization.js?v=77.4.1" in scripts
    assert "src/models/optimization-presets.js?v=77.4.1" in scripts
    assert "src/v72/optimization-workspace.js?v=77.4.1" in scripts
