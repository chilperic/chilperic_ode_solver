...
ok(runtime.includes("const RELEASE = '72.48.0'"), 'accessibility runtime has current release');
...
for (const name of pages) {
  ...
  ok(text.includes('v72-accessibility-performance.css?v=72.48.0'), name + ' loads accessibility CSS');
  ok(text.includes('v72/accessibility-performance.js?v=72.48.0'), name + ' loads accessibility runtime');
