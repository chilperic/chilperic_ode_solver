...
STATUS_ORDER = ["browser-computed", "limited-browser", "export-only", "unavailable"]
STATUS_LABELS = {
...
def human(key: str) -> str:
    return key.replace("_", " ").replace("ctmc", "CTMC").replace("ode", "ODE").replace("sse", "SSE").replace("pca", "PCA").replace("scipy", "SciPy").replace("sindy", "SINDy").replace("kkt", "KKT").strip().capitalize()
...
<body data-lab="trust"><div class="app-shell"><header class="topbar public-topbar foko-ide-topbar" data-v70-nav="true"><a aria-label="Foko Lab home" class="brand foko-wordmark" href="index.html"><img alt="Foko Lab" class="logo" src="assets/brand/foko-lab-logo.svg?v={VERSION}"/></a><nav class="foko-main-nav"></nav></header>
<main class="trust-page" id="main-content"><section class="trust-page-hero"><p class="trust-home-eyebrow">How to interpret a result</p><h1>What Foko Lab computed — and where the claim stops.</h1><p>Every capability carries a label that tells you whether the result was computed in the browser, produced by a bounded method, prepared for an external tool, or not offered.</p><div class="guide-sibling-links"><a href="docs.html">User Guide</a><a href="tutorial.html">Tutorials</a><a href="examples.html">Model Atlas</a></div></section>
