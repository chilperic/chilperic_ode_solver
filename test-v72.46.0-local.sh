#!/usr/bin/env bash
# Foko Lab v72.46.0 local validation runner.
...
EXPECTED_VERSION="72.46.0"
PREVIOUS_VERSION="72.45.0"
PORT=8100
BASE_DIR="${FOKOLAB_RELEASE_DIR:-$HOME/Downloads}"
ZIP_FILE="foko-lab-v72.46.0-platform-benchmark-hardening.zip"
TEST_DIR="foko-lab-v72-46-0-test"
PROJECT_DIR="$BASE_DIR/$TEST_DIR/foko-lab-v72.46.0-platform-benchmark-hardening"
ENV_DIR="$HOME/.venvs/fokolab-v72-46-0"
FAILED_GATE=""
