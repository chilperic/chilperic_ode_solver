...
ok(worker.includes("importScripts('../core/agent-reference.js?v=72.46.0')"), 'Agent worker loads the pure reference core');
...
ok(workspace.includes("new Worker('src/v72/agent-worker.js?v=72.46.0')"), 'Agent workspace runs ensembles in a Web Worker');
