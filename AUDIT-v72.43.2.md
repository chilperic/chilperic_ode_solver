# Foko Lab v72.43.3 — analysis taxonomy and scientific capability audit
...
## v72.43.3 Agent interaction closure
...
The local v72.41.5 gate did not reach its Agent layout assertions: it selected speed value `120`, while the rendered control exposes `180`, `90`, `45`, and `24`. v72.43.3 validates test inputs against the HTML control schema before browser execution.
...
## v72.43.3 plot, control and computation closure
