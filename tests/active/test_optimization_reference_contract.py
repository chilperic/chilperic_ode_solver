...
def test_optimization_is_an_authored_v72_reference_shell():
    ...
    assert "src/core/optimization.js?v=72.47.0" in scripts
    assert "src/models/optimization-presets.js?v=72.47.0" in scripts
    assert "src/v72/optimization-workspace.js?v=72.47.0" in scripts
