...
<link href="assets/brand/foko-lab-micro.svg?v={VERSION}" rel="icon" type="image/svg+xml"/><link href="styles/style.css?v={VERSION}" rel="stylesheet"/><link href="styles/v72-tokens.css?v={VERSION}" rel="stylesheet"/><link href="styles/v72-public-shell.css?v={VERSION}" rel="stylesheet"/><link href="styles/v76-system.css?v={VERSION}" rel="stylesheet"/></head>
<body data-lab="trust"><div class="app-shell"><header class="topbar v76-appbar" data-v76-appbar="true"><a class="v76-brand" href="index.html" aria-label="Foko Lab home"><img src="assets/brand/foko-lab-logo.svg" alt="Foko Lab"/></a></header>
<main class="trust-page" id="main-content"><section class="trust-page-hero"><p class="trust-home-eyebrow">How to interpret a result</p><h1>What Foko Lab computed — and where the claim stops.</h1><p>Every capability carries a label that tells you whether the result was computed in the browser, produced by a bounded method, prepared for an external tool, or not offered.</p><div class="guide-sibling-links"><a href="docs.html">Modeling handbook</a><a href="tutorial.html">21-part curriculum</a><a href="examples.html">Model Atlas</a></div></section>
